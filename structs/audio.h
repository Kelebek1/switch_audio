...
enum nn::audio::CommandType : u8 {
    /* 0x00 */ Invalid,
    /* 0x01 */ DataSourcePcmInt16V1,
    /* 0x02 */ DataSourcePcmInt16V2,
    /* 0x03 */ DataSourcePcmFloatV1,
    /* 0x04 */ DataSourcePcmFloatV2,
    /* 0x05 */ DataSourceAdpcmV1,
    /* 0x06 */ DataSourceAdpcmV2,
    /* 0x07 */ Volume,
    /* 0x08 */ VolumeRamp,
    /* 0x09 */ BiquadFilter,
    /* 0x0A */ Mix,
...
struct nn::audio::server::AddressInfo {
    ...
    /* 0x08 */ u64 size;
    /* 0x10 */ nn::audio::server::MemoryPoolInfoS* memoryPoolInfo;
    /* 0x18 */ u32 dspAddress;
}; // size = 0x20
...
struct nn::audio::SplitterInfo {
    ...
    /* 0x1C */ s32 sampleRate;
    /* 0x20 */ nn::audio::SplitterDestinationData* destinationHead;
    /* 0x28 */ nn::audio::SplitterDestinationData* destinationData;
}; // size = 0x30
...
struct nn::audio::server::SplitterInfo {
    ...
    /* 0x10 */ nn::audio::server::SplitterDestinationData* destinations;
    /* 0x18 */ s32 channelCount;
    /* 0x1C */ char unk1C[0x4];
}; // size = 0x20
...
struct nn::audio::server::VoiceContext {
    /* 0x00 */ nn::audio::server::VoiceInfo** sortedVoiceInfo;
    /* 0x08 */ nn::audio::server::VoiceInfo* voices;
...
enum nn::audio::dsp::MailboxMessage {
    ...
    /* 0x20 */ AudioRenderer_RenderResponse,
    /* 0x2A */ AudioRenderer_Render,
    /* 0x34 */ AudioRenderer_Shutdown,
};
